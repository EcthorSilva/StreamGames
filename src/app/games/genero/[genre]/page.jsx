            ...
            <div className="min-h-screen font-sans">
                <div className="w-full max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-12">
                        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-2">Jogos de {genreName}</h1>
                        <p className="text-lg text-gray-500">Explore nossa coleção de títulos do gênero {genreName.toLowerCase()}.</p>
                    </div>
                    {displayedGames.length > 0 ? (
                        ...
                        <div className="text-center py-16">
                            ...
                            <p className="mt-2 text-gray-500">Não encontramos jogos para o gênero "{genreName}" com esse termo de busca.</p>
                        </div>
                    )}
                </div>
            </div>
